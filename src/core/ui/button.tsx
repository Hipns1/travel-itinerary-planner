...
const buttonVariants = cva(
  'cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-50 shadow shadow-sm hover:bg-primary-50 hover:text-primary border border-primary',
        secondary:
          'bg-primary-50 text-primary border border-primary-500 shadow-sm hover:bg-primary hover:text-primary-50',
        ghost: 'hover:bg-accent hover:text-accent-foreground  border-none',
        link: 'text-primary underline-offset-4 hover:underline',
        input: 'hover:bg-accent hover:text-accent-foreground border border-primary-500 shadow-sm'
      },
      size: {
